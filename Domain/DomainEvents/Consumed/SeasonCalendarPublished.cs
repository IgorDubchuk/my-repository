...
namespace Domain.DomainEvents.Consumed
{
    public class SeasonCalendarPublished : ConsumedEvent
    {
        ...
        //}
        public SeasonCalendarPublished(DateTime eventDateTime, short year, IEnumerable<SeasonCalendarRace> races) : base(ConsumedEvent.GetTypeByCode(ConsumedEventTypesEnum.SeasonCalendarPublished), eventDateTime)
        {
